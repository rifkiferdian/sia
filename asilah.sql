...
--
-- Host: localhost
-- Generation Time: Feb 01, 2017 at 07:17 AM
...
INSERT INTO `acl` (`id`, `controller`, `action`, `parent`, `is_menu`, `label_menu`, `child`, `usergroup_id`, `icon`, `except_user`, `aktif`) VALUES
(12, 'acl', NULL, '0', 'Y', 'ACL', '', ',1,2,', 'fa-cogs', '', 'Y'),
(1, 'index', NULL, '0', 'N', 'Dashboard', '', ',1,2,', 'fa-dashboard', '', 'Y'),
(43, 'print', NULL, '0', 'Y', 'Print', ',44,', ',1,2,', 'fa-print', '', 'Y'),
...
(59, 'account', 'loginEnd', '0', 'N', 'login lagi', '', ',1,2,', 'fa-key', '', 'Y');
